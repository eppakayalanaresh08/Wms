...
const HeaderLogo: React.FC = () => {
  ...
  const fetchLogo = async () => {
    ...
    try {
      const response = await axios.get(
        `https://backend.gamanrehabcenter.com/website/user/${username}/logo/?logo_type=header`,
        {
          headers: {
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <p className="text-gray-400 mb-4">Please log in to manage the header logo</p>
          <button
  ...
  if (isLoading && !logo && !isModalOpen && !isDeleteModalOpen) {
    return (
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Header Logo Management</h2>
        {!logo && (
          <button 
      ...
      <div className="glass-card p-6 rounded-lg">
        <div className="text-center mb-6">
          <h3 className="text-lg font-medium mb-2">Current Header Logo</h3>
          <p className="text-gray-400 text-sm">This logo will be displayed in the header of your website</p>
        </div>
